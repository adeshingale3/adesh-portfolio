                ...
                <div className="relative z-10 flex items-center justify-center h-full px-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="https://drive.google.com/file/d/1Xbcg0I6Eem7VGKqia78Sh1nY-ZRQy5N8/view?usp=sharing" className="px-6 py-3 rounded-full bg-white/5 hover:bg-white/10 transition-colors">
                                 CV
                            </a>
                        </motion.div>
                    </motion.div>
