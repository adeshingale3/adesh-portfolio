...
const Socials = () => {
    const socials = [
        {
            name: "github", link: "https://github.com/adeshingale3", svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
        ...
        {
            name: "x", link: "https://x.com/adesshhhhh", svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
        ...
        {
            name: "linkedin", link: "https://www.linkedin.com/in/adesshhhhh/", svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
