...
export function ExperienceItem({
  ...
  return (
    <div className="space-y-4 py-4 bg-black">
      <div className="not-prose flex items-center gap-3">
        ...
        <h3 className="text-lg leading-snug font-medium text-foreground text-white">
      ...
      <div className="relative space-y-4 before:absolute before:left-3 before:h-full before:w-px before:bg-border text-white">
...
export function ExperiencePositionItem({
  ...
  return (
    <Collapsible defaultOpen={position.isExpanded} asChild>
      <div className="relative last:before:absolute last:before:h-full last:before:w-4 last:before:bg-background text-white">
        <CollapsibleTrigger
          className={cn(
