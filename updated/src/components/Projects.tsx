...
const Projects = () => {
    const projects = [
        { name: "Project 1", description: "This is a description for project 1", live: "", github: "", techstack: ["React", "Node.js"], image: "/project1.png" },
                { name: "Project 1", description: "This is a description for project 1", live: "", github: "", techstack: ["React", "Node.js"], image: "/project1.png" },
                    ...
                    <div className='mr-3 border-1 border-white/50 rounded-lg h-auto w-full flex flex-col'>
                        <div className='flex flex-row justify-between mx-4 my-3'>
                            ...
                            <div className='flex flex-row gap-2'>
                                <a href='' className='h-6 w-6 bg-white/90 rounded-sm flex justify-center items-center cursor-pointer'>
                        ...
                        <h4 className='italic text-[15px] mx-4 mb-2'>{prj.description}</h4>
